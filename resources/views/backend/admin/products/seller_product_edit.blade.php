...
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Publisher Edit  Products</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <!-- Main content -->
    <form role="form" id="choice_form" action="{{route('admin.update.seller.products',$product->id)}}" method="post"
                    ...
                    <div class="card card-info card-outline">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="tags[]" placeholder="Type to add a tag" value="{{ $product->tags }}" data-role="tagsinput">
                            </div>
                            <div class="form-group ">
