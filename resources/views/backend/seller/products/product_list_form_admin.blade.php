...
@section("title","Admin Inserted Product List ")
@push('css')
...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Admin Inserted Product List</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{route('seller.dashboard')}}">Home</a></li>
                        <li class="breadcrumb-item active">Admin Inserted Product List</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="col-12">
                <div class="card card-info card-outline">
                    <div class="card-header">
                        <h3 class="card-title float-left">Admin Inserted Product List</h3>
    ...
    <script>
        $(document).ready(function() {
            var table = $('#example').DataTable({
                'ajax': '{{url('seller/get/admin/products/ajax')}}',
                'columnDefs': [
                    {
                        'targets': 0,
                        'checkboxes': {
