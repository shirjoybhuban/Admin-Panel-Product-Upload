                ...
                <div class="card card-info card-outline">
                    <div class="card-header">
                        ...
                        <div class="float-right">
                            <a href="{{route('publisher.products.create')}}">
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <a class="bg-info dropdown-item" href="{{route('publisher.products.edit',encrypt($product->id))}}">
                                               ...
                                               {{-- <button class="bg-danger dropdown-item" type="button"
                                                ...
                                                <form id="delete-form-{{$product->id}}" action="{{route('publisher.products.destroy',$product->id)}}" method="POST" style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                            </div>
...
@push('js')
    ...
    <script>
        ...
        function update_todays_deal(el){
            ...
            $.post('{{ route('publisher.products.todays_deal') }}', {_token:'{{ csrf_token() }}', id:el.value, status:status}, function(data){
                if(data == 1){
        ...
        function update_published(el){
            ...
            $.post('{{ route('publisher.products.published') }}', {_token:'{{ csrf_token() }}', id:el.value, status:status}, function(data){
                if(data == 1){
        ...
        function update_featured(el){
            ...
            $.post('{{ route('publisher.products.featured') }}', {_token:'{{ csrf_token() }}', id:el.value, status:status}, function(data){
                if(data == 1){
